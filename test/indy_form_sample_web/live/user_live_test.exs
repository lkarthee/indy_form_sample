defmodule IndyFormSampleWeb.UserLiveTest do
  use IndyFormSampleWeb.ConnCase

  import Phoenix.LiveViewTest
  import IndyFormSample.AccountsFixtures

  @create_attrs %{age: 42, contact_me: :none, email: "some email", name: "some name", phone: "some phone"}
